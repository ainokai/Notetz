$(document).ready(function () {
  ...
  $('#btn-settingsSave').click(function () {
    alert('All changes saved.');
    return;
  });

  $('#btn-noOpenFunction').click(function () {
    alert('Open file -function is not supported in this version.');
    return;
  });

  $('#btn-noSaveFunction').click(function () {
    alert('Save file -function is not supported in this version.');
    return;
  });

  $('#btn-noSaveAsFunction').click(function () {
    alert('Save file as -function is not supported in this version.');
    return;
  });

  $('#btn-noDeleteFunction').click(function () {
    alert('Delete file -function is not supported in this version.');
    return;
  });

  $('#btn-noFindFunction').click(function () {
    alert('Find -function is not supported in this version.');
    return;
  });

  $('#btn-noUndoFunction').click(function () {
    alert('Undo -function is not supported in this version.');
    return;
  });

  $('#btn-noRedoFunction').click(function () {
    alert('Redo -function is not supported in this version.');
    return;
  });

  $('#btn-Guide').click(function () {
    alert('Guide of the system is not included in this version.');
    return;
  });
